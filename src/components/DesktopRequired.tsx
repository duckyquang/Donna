...
export default function DesktopRequired() {
  return (
    <div className="flex h-full w-full items-center justify-center bg-donna-bg p-6">
      <div className="w-full max-w-lg rounded-2xl border border-donna-accent/30 bg-donna-surface p-8">
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-donna-accent/15 text-donna-accent-light">
            <Monitor size={20} />
          </div>
          <div>
        ...
        <div className="mt-4 rounded-lg border border-white/10 bg-donna-bg p-4">
          <p className="mb-2 text-xs font-medium uppercase tracking-wide text-gray-500">
            Run this in your terminal
          </p>
          <code className="block text-sm text-donna-accent-light">npm run tauri:dev</code>
        </div>
